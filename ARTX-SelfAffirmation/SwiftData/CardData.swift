...
//        self.id = UUID().uuidString
    ...
    static var defaults: [CardData] {
        [
            .init(id: 0, title: "경제적으로 자유로운\n삶을 위해 2024년까지\n월 1억 시스템을 달성한다\n(카드가 길어져서 좀 더\n길게 들어가도 될 듯)", name: "MARCUS", image: "bg0", isLight: true),
            .init(id: 1, title: "단 하나의 꿈은,\n수천가지 현실적인 요소보다\n더 강력합니다.", name: "PUPPY", image: "bg1", isLight: true),
            .init(id: 2, title: "당신이 원하는 것은\n모두 두려움\n뒷 편에 있다.", name: "N.D", image: "bg2", isLight: false),
            .init(id: 3, title: "진정성, 균형,\n창의성, 경험,\n공정", name: "LENA", image: "bg3", isLight: false),
        ]
    }
